...
weeks_no = 2 # weeks
T = weeks_no * 7  # days
exclude_problematic_students = True
idx_to_cg = {}
cg_to_idx = {}
idx_students = []
...
if __name__ == "__main__":
    ...
    if isAdmin():
        ...
        try:
            ...
            student_df = pd.read_excel("data.xlsx", "List", engine='openpyxl')#.iloc[:100, :] # Limited Students
            ...
            w = db.add_set("w", 1, "weeks")
            for week_id in range(weeks_no):
                w.add_record(str(week_id+1))
